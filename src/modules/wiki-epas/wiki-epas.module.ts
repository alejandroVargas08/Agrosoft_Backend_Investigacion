...
@Module({
  imports: [TypeOrmModule.forFeature([EpaOrmEntity, WikiTipoEpaOrmEntity])],
  controllers: [EpasController, WikiTipoEpaController],
  providers: [
    CrearEpaUseCase,
    ObtenerEpaUseCase,
    ListarEpasUseCase,
  ...
  exports: [EPA_REPOSITORY_TOKEN, WIKI_TIPO_EPA_REPOSITORY_TOKEN],
})
