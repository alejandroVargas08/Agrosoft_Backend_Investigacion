...
import type { estadoActividad } from "../../domain/entities/actividades.entity";
...
export class ActividadesController {
    constructor(
        ...
        private readonly eliminarActividadesUseCase: eliminarActividadesUseCase,
    ) {}
    ...
    async crear(@Body() dto: crearActividadesDto) {
        ...
        return await this.crearActividadesUC.execute(dtoConFecha as any);
    }
    ...
    async actualizar(
        ...
        const dtoConFecha = dto.fecha ? { ...dto, fecha: new Date(dto.fecha) } : dto;
        return await this.actualizarActividadesUC.execute(id, dtoConFecha as any);
    }
    ...
    async eliminar(@Param('id', ParseIntPipe) id: number) {
        await this.eliminarActividadesUseCase.execute(id);
